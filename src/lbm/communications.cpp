...
/// @brief Vertical ghost row exchange using a single packed message per direction.
/// Packs row y into mesh_comm->buffer, sends/receives as one MPI message, then unpacks.
